                ...
                <div class="col-md-5 border-right">
                    <div class="p-3 py-5">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h4 class="text-right">Agregar usuario</h4>
                        </div>
                        <div class="row mt-2">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-12"><label class="labels">Contraseña</label><input type="password" class="form-control"  value=""></div>
                        </div>
                        <a href="usuarios.php">
                        <div class="mt-5 text-center"><button class="btn btn-primary profile-button" type="button">Agregar</button></div>
                        </a>
